...
import { Github, Heart, Code2, Users, Smartphone } from "lucide-react";
                ...
                <div className="grid grid-cols-1 gap-8 sm:gap-10 lg:gap-12 lg:grid-cols-2 lg:items-center">
                  ...
                  <div>
                    ...
                    <p className="mb-6 sm:mb-8 text-sm sm:text-base text-muted-foreground leading-relaxed">
                      The project is not-for-profit, funded by <strong className="text-foreground">SoftGlitch Solutions</strong>, 
                      and we gladly accept donations and additional funding to keep the services running and 
                      continuously improving for South African communities.
                    </p>
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    <InfoCard
                      ...
                      description="Built with React Native for cross-platform mobile and Supabase for the backend."
                    />
                    <InfoCard
                      icon={<Users className="h-5 w-5 sm:h-6 sm:w-6" />}
                      title="Funded by SoftGlitch Solutions"
                      description="Proudly supported and funded by SoftGlitch Solutions to keep the platform free."
                    />
                    <InfoCard
...
const InfoCard = ({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) => (
  <div className="flex gap-3 sm:gap-4 rounded-lg sm:rounded-xl bg-muted p-4 sm:p-5">
    <div className="flex-shrink-0 rounded-md sm:rounded-lg bg-primary p-2 sm:p-2.5 text-primary-foreground">{icon}</div>
    <div>
